...
public class AccountActivity extends AppCompatActivity {
    ...
    private MyDialogBuilder mDialogBuilder_logIn;
    private AlertDialog mDialog_logIn = null;
    ...
    private MyAdapter mAdapter_sendLocation, mAdapter_getLocation;
    ...
    private void makeViewWork() {
        ...
        mAdapter_sendLocation = new MyAdapter(mUserList_sendLocation);
        mAdapter_getLocation = new MyAdapter(mUserList_getLocation);
...
//                Toast.makeText(AccountActivity.this, R.string.wrong_user, Toast.LENGTH_SHORT).show();
    ...
    class MyButtonClickListener implements View.OnClickListener {
        ...
        @Override
        public void onClick(View v) {
            mDialogBuilder_logIn = new MyDialogBuilder(AccountActivity.this, resId_title);
            switch (v.getId()) {
                //點擊定位用的註冊按鈕
                case R.id.btn_sendLocation_signUp: {
                    getPhoneInfo();
                    mDialogBuilder_logIn.setOnButtonClickListener(
                ...
                case R.id.btn_sendLocation_logIn: {
                    getPhoneInfo();
                    mDialogBuilder_logIn.setBtn_forgetPasswordVisibility(View.VISIBLE);
                    mDialogBuilder_logIn.setOnButtonClickListener(
            ...
            mDialog_logIn = mDialogBuilder_logIn.create();
            mDialog_logIn.show();
        }
    }

    //mDialog_logIn 的按鈕監聽器
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.dialog_btn_cancel) {
                ...
                switch (task) {
                    case TASK_SIGN_UP: {
                        //註冊定位用的帳號
                        mAccount_sendLocation = mDialogBuilder_logIn.getAccount();
                        mPassword_sendLocation = mDialogBuilder_logIn.getPassword();
                    ...
                    case TASK_LOGIN_TO_GET_LOCATION: {
                        //登入定查詢的帳號
                        mAccount_getLocation = mDialogBuilder_logIn.getAccount();
                        mPassword_getLocation = mDialogBuilder_logIn.getPassword();
                ...
                mBtn_forgetPassword_send_verification_code.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!(mAccount_forgetPassword.trim()).equals("") && !(mEmail.trim()).equals("")
                            ...
                            //送出 HttpRequest，使用者請到 mEmail 收驗證碼
